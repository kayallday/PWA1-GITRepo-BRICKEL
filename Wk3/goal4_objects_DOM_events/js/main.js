...
//{KEY : Value} pairings,
	person = {'name':'bond', 'age':35, 'secretAgent':true};  //set up as strings

	person = {name:'bond', age:35, secretAgent:true};		 //don't set up as string
...
var nav = document.querySelectorAll('#nav li a');
	...
	for (var i = 0, max = nav.length; i < max; i++){
		...
		nav[i].onclick = function(e){		//on click event
			console.log(e);
